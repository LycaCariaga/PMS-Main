        ...
        <div class="col-lg-12">
          ...
          <div class="section-body">
            <div class="row">
                      ...
                      <div class="row g-2">
                        <ul>
                          <div class="mx-auto" style="width: 200px;">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Diabetes" id="flexCheckDiabetes">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Heart Disease" id="flexCheckHD">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Allergy" id="flexCheckAllergy">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Measles" id="flexCheckMeasles">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Asthma" id="flexCheckAsthma">
                        ...
                        <ul>
                          <div class="mx-auto" style="width: 200px;">  
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Hepatitis" id="flexCheckHepatitis">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Seizures" id="flexCheckSeizures">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Scoliosis" id="flexCheckScoliosis">
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Otitis External/Media" id="flexCheckOE">
                        ...
                        <ul>
                          <div class="mx-auto" style="width: 200px;">    
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" name="history[]" value="Urinary Track Infection" id="flexCheckUTI">
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="history[]" value="Mumps" id="flexCheckMumps">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="history[]" value="Chicken Pox" id="flexCheckChicken">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="history[]" value="Thypoid" id="flexCheckThypoid">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="history[]" value="Nose Bleeding" id="flexCheckNose">
