                                  ...
                                  <table class="table table-bordered" id="table">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td class="col-md-2">
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flexRadioRow1" id="flexRadio1">
                                            <label class="form-check-label" for="flexRadio1">
                                              Normal
                                            </label>
                                          </div>
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flexRadioRow1" id="flexRadio2">
                                      ...
                                      <tr>
                                        ...
                                        <td class="col-md-2">
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flexRadioRow2" id="flexRadioRow2-1">
                                            <label class="form-check-label" for="flexRadioRow2-1">
                                              Normal
                                            </label>
                                          </div>
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flexRadioRow2" id="flexRadioRow2-2" >
                                      ...
                                      <tr>
                                        ...
                                        <td class="col-md-2">
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flexRadioRow3" id="flexRadioRow3-1">
                                            <label class="form-check-label" for="flexRadioRow3-1">
                                              Normal
                                            </label>
                                          </div>
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="flexRadioRow3" id="flexRadioRow3-2" >
                          ...
                          <form class="row g-2">
                            ...
                            <div class="col-md-12">
                              ...
                              <form class="row g-2">
                                ...
                                <div class="modal-footer text-right">
                                  <div class="container d-flex justify-content-end">
                                    <button type="submit" class="btn btn-icon icon-left btn-primary mr-5"><i class="far fa-save"></i> Save</button>
