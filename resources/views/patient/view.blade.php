          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="text-center">
                <i class="fas fa-user" style="font-size: 10rem"></i>
              </div>
              
              <hr>
              <h4>NAME: {{ $patients->first_name }} {{ $patients->middle_name }} {{ $patients->last_name }}</h4>
              <h5>AGE: {{ $patients->getAge() }}</h5>
              <h5>DATE OF BIRTH: {{ $patients->birthday }}</h5>
              <h5>DEPARTMENT: {{ $patients->department->department }}</h5>
              <h6> MEDICAL HISTORY: 
